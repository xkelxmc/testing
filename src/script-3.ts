...
class LootTable {
  constructor(lootTables: Loottable[], lootBuckets: Lootbuckets[]) {}
...
(async () => {
  ...
  //examples:
  const exampleGraph = new LootTable(lootTables, lootBuckets);
  console.log(exampleGraph.findNodeById('CreatureLootMaster'));
})();
